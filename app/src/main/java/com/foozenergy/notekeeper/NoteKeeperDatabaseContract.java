...
public final class NoteKeeperDatabaseContract {
    ...
    public static class CourseInfoEntry implements BaseColumns {
        ...
        public static final String SQL_CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
                "("+ _ID + " INTEGER PRIMARY KEY, " + COLUMN_COURSE_ID + " TEXT UNIQUE NOT NULL, "
                + COLUMN_COURSE_TITLE +
                " TEXT NOT NULL);";
    }
    ...
    public static class NoteInfoEntry implements BaseColumns{
        ...
        public static final String SQL_CREATE_TABLE = "CREATE TABLE "+ TABLE_NAME +
                "("+ _ID + " INTEGER PRIMARY KEY, " + COLUMN_NOTE_TITLE+" TEXT NOT NULL, " +
                COLUMN_NOTE_TEXT + " TEXT, " + COLUMN_COURSE_ID + " TEXT NOT NULL);";
    }
}
