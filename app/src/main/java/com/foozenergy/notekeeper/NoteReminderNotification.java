...
public class NoteReminderNotification {
    ...
    public static void notify(final Context context, final String noteTitle,
                              final String noteText, final int noteId) {
        final Resources res = context.getResources();

        // This image is used as the notification's large icon (thumbnail).
        // TODO: Remove this if your notification has no relevant thumbnail.
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.ic_stat_note_reminder);

        final Intent noteActivityIntent = new Intent(context, NoteActivity.class);
